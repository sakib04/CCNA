...
```math
"
2 ^ 0 +2^64 + 2^32+ 2^16 + 2^8 + 2^4 + 2^2 + 2^1+ 2^0 = 127  "
```
...
**ক্লাস B** IP ঠিকানা একটি বিশেষ রেঞ্জের মধ্যে আসে, যা **128.0.0.0** থেকে **191.255.255.255** পর্যন্ত বিস্তৃত। এই ক্লাসের IP ঠিকানা ব্যবহৃত হয় বড় প্রতিষ্ঠানে বা অন্যান্য নেটওয়ার্কগুলির জন্য যেখানে অনেকগুলো ডিভাইস বা হোস্ট থাকতে পারে।
