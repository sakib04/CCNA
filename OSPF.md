...
- সর্বাধিক ব্যবহৃত লিংক-স্টেট আইপি রাউটিং প্রোটোকল।  
...
**উদাহরণ (Example)**:  
- চিত্র ১৯.৫-এ R8 রাউটার তার এলএসএ-তে `172.16.3.0/24` সাবনেটের তথ্য প্রচার করে।  
- *বাংলা*: অন্যান্য রাউটারগুলি এই এলএসএ পেয়ে LSDB আপডেট করে এবং SPF অ্যালগরিদম দিয়ে নতুন রুট যোগ করে।
