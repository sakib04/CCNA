...
**বন্যা প্রক্রিয়া (Flooding Process)**:  
  - **ধাপ ১**: একটি রাউটার (যেমন R8) তার এলএসএ তৈরি করে এবং প্রতিবেশী রাউটারে পাঠায়।  
...
**সর্বোত্তম পথ গণনা (SPF Algorithm)**:  
- **ডিজকস্ট্রা অ্যালগরিদম (Dijkstra’s SPF)**:  
  - LSDB বিশ্লেষণ করে প্রতিটি রাউটার নিজের জন্য সর্বোত্তম পথ (শর্টেস্ট পাথ) বের করে।  
  - এই অ্যালগরিদম টপোলজি ডেটা ব্যবহার করে আইপি রাউটিং টেবিলে রুট এন্ট্রি যোগ করে (যেমন: গন্তব্য সাবনেট, নেক্সট-হপ আইপি)।  
- মজার বিষয় রাউটারগুলি গণিত করে, কিন্তু নেটওয়ার্ক অ্যাডমিনদের ডিজকস্ট্রা অ্যালগরিদম বুঝতে হবে না!  
...
- **প্রতিবেশী সাক্ষাতের উপমা**:  
  ...
  - *বাংলা*: রাউটারগুলি নেটওয়ার্কে "হ্যালো" বলে পরিচয় দেয় এবং প্রতিবেশীর রাউটার আইডি (RID) শেখে।  
...
- **রাউটার আইডি (Router ID – RID)**:  
  ...
  - *বাংলা*: RID রাউটারের জন্য একটি নামের মতো কাজ করে। ডিফল্টভাবে, IOS রাউটারের কোনো ইন্টারফেসের IPv4 ঠিকানা ব্যবহার করে।  
  - **কাস্টম RID**: অধ্যায় ২০-এ কনফিগারেশন পদ্ধতি বর্ণনা করা হয়েছে।  
...
2. **মাল্টিকাস্ট ঠিকানা**: হ্যালো প্যাকেটগুলি **224.0.0.5** মাল্টিকাস্ট আইপি ঠিকানায় পাঠানো হয়।  
   - *বাংলা*: এই ঠিকানায় শুধুমাত্র OSPF রাউটারগুলি শোনে।  
...
1. **ডাউন স্টেট (Down)**:  
   ...
   - *বাংলা*: চিত্র ১৯.৭-এর প্রাথমিক ধাপে R1 ও R2 একে অপরের অস্তিত্ব জানে না।  

2. **ইনিট স্টেট (Init)**:  
   - একটি রাউটার প্রথম হ্যালো পেলে প্রতিবেশীকে **Init** স্টেটে তালিকাভুক্ত করে।  
   - *বাংলা*: উদাহরণস্বরূপ, R2 প্রথমবার R1-এর হ্যালো পেলে তাকে Init স্টেটে রাখে।  

3. **২-ওয়ে স্টেট (2-Way)**:  
   - উভয় রাউটার একে অপরের হ্যালো প্যাকেট পেলে **2-Way** স্টেটে প্রবেশ করে।  
   - *বাংলা*: এই স্টেটে তারা নিশ্চিত করে তাদের OSPF প্যারামিটার (এলাকা, টাইমার) মিলেছে।  
   - **গুরুত্ব**:  
