...
| subnet mask | 172 | 16 | 111  00000 | 00000000 |
...
| ip address | Network | Network | Network + Hosts | Hosts | 
| - | - | - | - | - | 
| 172.16.32.123| 172 | 16 |  0010 0000 | 00000000 |
| 1st host | 172 | 16 |  0010 0000 | 00000001 |
``` css
 1st host = 172.16. 0010 0000.00000001 = 172.16.32.1
```
...
| last host | 172 | 16 | 0010 1111  | 11111110 |
``` css
last host = 172.16.1 0010 1111.11111110 = 172.16.47.254
```
| ip address | Network | Network | Network + Hosts | Hosts | 
| - | - | - | - | - | 
| 172.16.32.123| 172 | 16 | 0010 0000  | 00000000 |
| last host | 172 | 16 | 0010 1111  | 11111111 |
``` css
last host = 172.16.1 0010 1111.11111111 = 172.16.47.255
```
